      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 w-full flex items-center justify-center relative h-[400px] lg:h-[500px] order-1 lg:order-2">
            ...
            {/* Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-gradient-to-r from-green-500/20 to-cyan-500/20 rounded-full blur-[90px] animate-pulse-subtle pointer-events-none"></div>
            ...
            <div className="relative w-full max-w-[500px] h-full">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                    {/* Separate Float Animation from Rotation */}
                    <div className="animate-float">
                        <div className="w-56 h-56 sm:w-64 sm:h-64 rounded-3xl overflow-hidden border-2 border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.5)] bg-slate-900 group transform hover:scale-105 transition-transform duration-500">
                            <img 
                ...
                <div className="absolute top-[10%] right-[5%] z-10 hidden sm:block">
                    <div className="animate-float-fast" style={{animationDelay: '1s'}}>
                ...
                <div className="absolute bottom-[15%] left-[0%] z-30 hidden sm:block">
                    <div className="animate-float" style={{animationDelay: '2s'}}>
                        <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-3xl overflow-hidden border border-white/20 shadow-2xl bg-slate-900 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                             <img 
                                src="https://images.unsplash.com/photo-1622979135225-d2ba269fb1a2?auto=format&fit=crop&w=500&q=80" 
                                alt="Tech Reward" 
                                className="w-full h-full object-cover opacity-90 hover:opacity-100 transition-opacity" 
                                referrerPolicy="no-referrer"
                             />
